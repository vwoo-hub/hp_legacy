...
from pages.log_in.incorrect_password_dialog_page import IncorrectPasswordDialogPage
...
class TestSignIn(BaseTest):
    ...
    def test_when_email_not_recognized_then_shows_error_dialog(self):
        with self.landing_page.wait_for_page() as page:
            page.tap_log_in_button()

        with self.log_in_page.wait_for_page() as page:
            page.type_email_text_field("fake@email.com")
            page.type_password_text_field("plumewifi1")
            page.tap_sign_in_button()
